...
import {
  ...
  AlertTriangle, Play, Zap, GitBranch, Bot, Terminal,
...
type TabId = "builds" | "skills" | "projects";
...
export function FactoryView() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      {tab === "builds" ? <BuildsTab /> : tab === "skills" ? <SkillsTab /> : <ProjectsTab />}
    </div>
  );
}
...
/* ══════════════════════════════════════════════════════════════════════
   SKILLS TAB — (unchanged from previous)
   ══════════════════════════════════════════════════════════════════════ */
